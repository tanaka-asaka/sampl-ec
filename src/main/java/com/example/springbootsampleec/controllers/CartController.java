...
public class CartController {
	...
	public String addCart(@PathVariable("id") Long id, RedirectAttributes redirectAttributes,
	...
	public String addCartDetail(@PathVariable("id") Long id, RedirectAttributes redirectAttributes,
			@AuthenticationPrincipal(expression = "user") User user, Model model) {
		cartService.addCart(user, id);
	...
	public String purchase(RedirectAttributes redirectAttributes,
		...
		if (cartService.purchase(user)) {
			...
			redirectAttributes.addFlashAttribute("errorMessage", "商品を購入できませんでした。");
